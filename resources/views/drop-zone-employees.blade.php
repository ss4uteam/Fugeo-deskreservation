            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <ul class="-ml-6 mt-8 mb-4 list-disc pl-10 text-left">
                        ...
                        <li>If the CSV doesn't have Username and Password, email id will be populated as Username and Password</li>
                        <li>Required columns:</li>
                        <h4><code class="bg-carbon-5 text-carbon-50 py-2 px-4">Employee ID,First Name, Last Name,
                                Email Id, Designation, Department, Username, Password</code></h4>
                    </ul>
                    </p>
