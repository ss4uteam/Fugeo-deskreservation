...
<link href="{{ URL::asset('/assets/libs/select2/select2.min.css') }}" id="select2-style" rel="stylesheet" type="text/css" />
    ...
    <div class="col-12">
        ...
        <select class="form-control select2">
            ...
            <optgroup label="Alaskan/Hawaiian Time Zone">
                <option value="AK">Jhon</option>
                <option value="HI">Jhon Doe</option>
                <option value="HI">Jhon Doe Simon</option>
            </optgroup>
        </select>
...
<script>
    ...
    function popupContentReady(id, employeeName = '', deskName = '') {
        ...
        //         </div>\
        //         <div class='mb-3'>\
        //         <label for='employeeName' class='form-label'>Neighbourhood/Zone<span style='color:red'>*</span></label>\
        ...
        return "<div class='row popcontent-" + id +
            ...
            "'name='deskName' autofocus>\
                    ...
                    <div class='mb-3'>\
                    <label for='employeeName' class='form-label'>Neighbourhood/Zone</label>\
                    <input type='text' class='form-control employeeName @error('employeeName') is-invalid @enderror' id='employeeName-" +
            id +
            "' value='Zone' name='employeeName' autofocus>\
                    </div>\
                    <div class='mb-3'>\
                    <label for='employeeName' class='form-label'>Assign Desk To<span style='color:red'>*</span></label>\
                    <select class='form-control select2'>\
                                                            <option>Select</option>\
                                                            <option>Jhon</option>\
                                                            <option>Jhon Doe</option>\
                                                            <option>Jhon Doe Simon</option>\
                                                        </select>\
                                                        </div>\
                    <div class='d-flex align-items-center justify-content-around'>\
                    \<button data-classname='popcontent-'" + id +
