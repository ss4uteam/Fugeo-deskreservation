                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="validationCustom01" name="username" placeholder="Employee ID" value="{{ old('username') }}" required>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="email" class="form-control" id="validationCustom01" name="password" placeholder="Email Id" value="{{ old('password') }}" required>
                                <div class="valid-feedback">
                                    Looks good!
                                </div>
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                <label for="validationCustom04" class="form-label">Username<span style="color:red">*</span></label>
                                <input type="text" class="form-control" id="validationCustom04" name="department" placeholder="Username" required>
                                <div class="valid-feedback">
                                    Looks good!
                                </div>
                                <span class="text-danger">@error('department')
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="validationCustom01" name="password" placeholder="Password" value="{{ old('password') }}" required>
                                <div class="valid-feedback">
                                    Looks good!
                                </div>
                                <span class="text-danger">@error('password')
