            ...
            <form action="{{ route('createFloor') }}" method="post" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('floorName') is-invalid @enderror" id="floorName" value="Floor 4" name="floorName" autofocus>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            <input type="file" class="form-control @error('floorMap') is-invalid @enderror" id="floorMap" name="floorMap" autofocus required>
            ...
            <div class="card-body">
                <div class="row mb-3 align-items-center">
                    ...
                    <div class="col-sm-12 col-md-6 text-start">
                        <h4 class="card-title">All Desk</h4>
                    </div>
                    <div class="col-sm-12 col-md-6 text-end">
                        <button class="btn btn-success btn-lg" type="button" data-bs-toggle="modal" data-bs-target="#createFloor">
                ...
                <x-table>
                    ...
                    <tr class="font-bold" id="tr_{{ Auth::user()->id }}">
                        ...
                        <x-table-column>{{ $floor->floor_name }}
                            <p class="fs-6">2 Enabled desks</p>
                        </x-table-column>
                        <x-table-column id="td_{{ Auth::user()->id }}">
                            <img class="desk-overview-img" src="{{ isset(Auth::user()->id) ? asset($floor->floor_map) : asset('/assets/images/users/avatar-1.jpg') }}" alt="" />
                        </x-table-column>
                        <x-table-column>
                            <div class="table-action">
                                ...
                                <form class="d-inline delete-icon
                                            position-relative mb-0" action="{{ route('floor.destroy', ['id' => $floor->id]) }}" method="post">
                                    @csrf
                                    @method('DELETE')
